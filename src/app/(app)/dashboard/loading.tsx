          ...
          {[...Array(4)].map((_, i) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="w-10 h-10 bg-slate-800/30 rounded-lg animate-pulse" />
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {[...Array(2)].map((_, i) => (
            ...
            >
              ...
              <div className="h-48 bg-slate-800/20 rounded-lg animate-pulse flex items-center justify-center">
