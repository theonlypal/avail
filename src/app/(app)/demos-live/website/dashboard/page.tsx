      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white border-white/10">
          <CardContent className="py-8 text-center">
            <h3 className="text-2xl font-bold mb-4">Interactive Demo Dashboard</h3>
            <p className="mb-4 text-blue-100">
              This dashboard shows real-time lead capture data from the AI chat widget.
            </p>
            <p className="text-sm text-cyan-200">
              Try the chat widget on the main page to see leads appear here instantly.
            </p>
          </CardContent>
        </Card>
      </div>
