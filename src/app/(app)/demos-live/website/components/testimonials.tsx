...
import { Star, ThumbsUp, MessageCircle, Filter, Camera, Info } from "lucide-react";

// DEMO DATA: Sample reviews for demonstration purposes only
// In production, these would come from actual Google/Yelp API integrations
const allReviews = [
  {
    id: 1,
    name: "Sarah Mitchell",
    ...
    <section id="testimonials" className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-blue-900">Demo Preview</p>
            <p className="text-sm text-blue-800">
              These are sample reviews for demonstration. In your implementation,
              AVAIL integrates with Google, Yelp, and Facebook to display your actual customer reviews.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">{totalReviews} sample reviews</p>
        </div>
