...
function convertBusinessesToLeads(businesses: any[], query: DiscoveryQuery): DiscoveredLead[] {
  return businesses
    ...
    .map((business) => ({
      ...
      phone: business.phoneNumber || business.phone || undefined,
      email: undefined,
      website: business.website || undefined,
      rating: business.rating || undefined,
      review_count: business.reviews || business.reviewCount || undefined,
      lat: business.gps_coordinates?.latitude || business.latitude || undefined,
      lng: business.gps_coordinates?.longitude || business.longitude || undefined,
